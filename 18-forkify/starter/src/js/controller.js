...
const showRecipe = async function() {
  try {
    ...
    const markup = `
      ...
      <div class="recipe__ingredients">
        ...
        <ul class="recipe__ingredient-list">
          ${recipe.ingredients.map(ing => { // using map array method to return the html for each ingredient
            return `
            ...
            `; // join puts the results of the map method into one string
          }).join('')} 
    ...
    `;
    recipeContainer.innerHTML = ''; // clears html in container
    recipeContainer.insertAdjacentHTML('afterbegin', markup); // this inserts the the markup named markup above after begin
